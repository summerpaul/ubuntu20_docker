...
(cl:defclass <Path> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (points
    :reader points
    :initarg :points
    :type (cl:vector autoware_planning_msgs-msg:PathPoint)
   :initform (cl:make-array 0 :element-type 'autoware_planning_msgs-msg:PathPoint :initial-element (cl:make-instance 'autoware_planning_msgs-msg:PathPoint)))
   (drivable_area
...
(cl:defmethod cl:initialize-instance :after ((m <Path>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Path)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_planning_msgs-msg:<Path> is deprecated: use autoware_planning_msgs-msg:Path instead.")))
...
(cl:defmethod drivable_area-val ((m <Path>))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Path>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'autoware_planning_msgs-msg:PathPoint))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Path>)))
  ...
  "cacbdedd66c074665334472dc2f63729")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Path)))
  "Returns md5sum for a message object of type 'Path"
  "cacbdedd66c074665334472dc2f63729")
